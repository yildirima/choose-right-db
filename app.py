...
# Database lists based on the decision tree database_lists = {
...
@app.route('/result')
def result():
    # Determine the correct database category based on user input
...
def determine_category():
    ...
    if answer_1 == 'Operational':
        if answer_2 == 'Batch':
            ...
            return 1 if answer_3 == 'SQL' else 5  # Relational DB or Document Data Stores
        ...
        return 11 if answer_2 == 'SQL' else 12  # SQL vs. Multi-attribute for HTAP
